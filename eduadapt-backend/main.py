...
# ─── Prompts ──────────────────────────────────────────────
PROMPTS = {
    "tdah": """Eres un diseñador pedagógico especializado en Universal Design for Learning (UDL). Adapta el texto para estudiantes con TDAH. REGLAS: Divide en bloques de MÁXIMO 30 palabras. Una sola idea por bloque. Usa un emoji. Solo pon en **negrita** el concepto más importante. TEXTO: {texto} Responde SOLO en este JSON: {{"resumen": "1 oración gancho", "bloques": ["🎯 bloque 1", "⚡ bloque 2"], "glosario": [{{"termino": "Concepto", "definicion": "Analogía simple"}}], "mapa_mermaid": "graph TD\\n A[Idea Principal] --> B[Detalle]", "quiz": [{{"pregunta": "Pregunta rápida", "opciones": ["A", "B", "C"], "respuesta": 0}}], "resumen_oral": "versión corta para audio"}}""",
    "dislexia": """Eres un diseñador pedagógico especializado en dislexia. REGLAS: PROHIBIDO usar negritas, cursivas o subrayados. Oraciones cortas, párrafos de 2 líneas. Tono calmado. TEXTO: {texto} Responde SOLO en este JSON: {{"resumen": "Resumen simple.", "bloques": ["Oración simple 1.", "Oración simple 2."], "glosario": [{{"termino": "palabra", "definicion": "explicación simple"}}], "mapa_mermaid": "graph TD\\n A[Paso 1] --> B[Paso 2]", "quiz": [{{"pregunta": "Pregunta clara", "opciones": ["A", "B", "C"], "respuesta": 0}}], "resumen_oral": "versión simple para escuchar"}}""",
    "auditivo": """Eres un diseñador pedagógico especializado en aprendizaje auditivo. REGLAS: Narrativa hablada natural, tono de podcast/cuento. TEXTO: {texto} Responde SOLO en este JSON: {{"resumen": "intro estilo podcast", "bloques": ["narrativa 1", "narrativa 2"], "glosario": [{{"termino": "palabra", "definicion": "metáfora"}}], "mapa_mermaid": "graph TD\\n A[Concepto] --> B[Ejemplo]", "quiz": [{{"pregunta": "pregunta", "opciones": ["A", "B", "C"], "respuesta": 0}}], "resumen_oral": "guión completo para narrar en voz alta"}}"""
}
